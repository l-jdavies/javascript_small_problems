...
function mailCount(emailData) {
  let splitEmails = emailData.split('##||##');
  let emailDates = splitEmails.map(email => email.split('#/#')[2])
  let dateData = {};

  console.log(`Count of Email: ${splitEmails.length}`);
