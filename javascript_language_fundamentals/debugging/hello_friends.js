...
// The code `const greeting + randomGreeting` should include parenthesis after the `randomGreeting` to invoke the function, rather than return the function itself
//
// Also, the `randomGreeting` function was lacking an explicit return statement at the end, which means invoking the function just returned `undefined`
